...
export default class {
  generic(msg, fileName, level) {
    msg = `${this.name}: [${level.toUpperCase()}] ${fileName}: ${msg}`;
  ...
  log(msg, fileName = '') {
    this.generic(msg, fileName, 'log');
  }

  info(msg) {
    this.generic(msg, fileName, 'info');
  }

  warn(msg) {
    this.generic(msg, fileName, 'warn');
  }

  debug(msg) {
    this.generic(msg, fileName, 'debug');
  }

  error(msg) {
    this.generic(msg, fileName, 'error');
  }
}
