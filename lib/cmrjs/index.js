...
export async function ingestCollection(xml, cmrProvider) {
  return ingestConcept('collection', xml, 'Collection.DataSetId', cmrProvider);
}


export async function ingestGranule(xml, cmrProvider) {
...
export async function deleteGranule(granuleUR, cmrProvider) {
