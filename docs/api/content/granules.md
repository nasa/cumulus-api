...
```curl
$ curl https://cumulus.developmentseed.org/api/dev/granules --header 'Authorization: TokenFromAuthorizationEndpoint'
```
...
```curl
$ curl https://cumulus.developmentseed.org/api/dev/granules/1A0000-2016121001_002_001 --header 'Authorization: TokenFromAuthorizationEndpoint'
```
...
```curl
$ curl --request PUT https://cumulus.developmentseed.org/api/dev/granules/1A0000-2016121001_002_001 --header 'Authorization: TokenFromAuthorizationEndpoint' --data '{"action": "reprocess"}'
```
...
```curl
$ curl --request PUT https://cumulus.developmentseed.org/api/dev/granules/1A0000-2016121001_002_001 --header 'Authorization: TokenFromAuthorizationEndpoint' --data '{"action": "reingest"}'
```
...
```json
{
    "MD5OfMessageBody": "8b1ee418f5489a39cab8e004ed74698d",
    "MessageId": "b8bbadfe-237a-4177-bc7e-3a91f76b2570",
    "ResponseMetadata": {
        "RequestId": "30c3d292-c37a-59e4-8031-83fafd1bf260"
    }
}
```
...
```curl
$ curl --request PUT https://cumulus.developmentseed.org/api/dev/granules/1A0000-2016121001_002_001 --header 'Authorization: TokenFromAuthorizationEndpoint' --data '{"action": "removeFromCmr"}'
```
...
```curl
$ curl --request DELETE https://cumulus.developmentseed.org/api/dev/granules/1A0000-2016121001_002_001 --header 'Authorization: TokenFromAuthorizationEndpoint'
