...
```curl
$ curl https://example.com/granules --header 'Authorization: Bearer ReplceWithTheToken'
```
...
```curl
$ curl https://example.com/granules/1A0000-2016121001_002_001 --header 'Authorization: Bearer ReplceWithTheToken'
```
...
```curl
$ curl --request PUT https://example.com/granules/1A0000-2016121001_002_001 --header 'Authorization: Bearer ReplceWithTheToken' --data '{"action": "reprocess"}'
```
...
```curl
$ curl --request PUT https://example.com/granules/1A0000-2016121001_002_001 --header 'Authorization: Bearer ReplceWithTheToken' --data '{"action": "reingest"}'
```
...
```curl
$ curl --request PUT https://example.com/granules/1A0000-2016121001_002_001 --header 'Authorization: Bearer ReplceWithTheToken' --data '{"action": "removeFromCmr"}'
```
...
```curl
$ curl --request DELETE https://example.com/granules/1A0000-2016121001_002_001 --header 'Authorization: Bearer ReplceWithTheToken'
